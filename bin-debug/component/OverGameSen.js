 ...
 *
 */
var OverGameSen = (function (_super) {
    __extends(OverGameSen, _super);
    function OverGameSen() {
        _super.call(this);
    ...
    var d = __define,c=OverGameSen,p=c.prototype;
    ...
    p.start = function (games, obj, mopai) {
        this.oldobj = obj;
        this.redytuichu = false;
        this.mopai = mopai;
   ...
   *hu处理
   */
    p.huchuli = function (obj, pai, hu, da, shufan, hufan, obj2) {
        var fannum = 1;
        if (obj.roomtype == "0") {
            fannum = 50;
        }
    ...
    p.dealPai = function (arr1, group, typepng, hupai, zimo) {
        if (hupai === void 0) { hupai = null; }
        if (zimo === void 0) { zimo = null; }
        var gangarr = [];
        var dealX = 0;
        if (arr1.gang) {
    ...
    */
    ...
    p.end = function (str) {
        ...
        while (this.group.numChildren > 0) {
            GamePool.getInstance().setPNG(this.group.removeChild(this.group.getChildAt(0)));
        }
        while (this.group0.numChildren > 0) {
            GamePool.getInstance().setPNG(this.group0.removeChild(this.group0.getChildAt(0)));
        }
        while (this.group1.numChildren > 0) {
            GamePool.getInstance().setPNG(this.group1.removeChild(this.group1.getChildAt(0)));
        }
        while (this.group2.numChildren > 0) {
            GamePool.getInstance().setPNG(this.group2.removeChild(this.group2.getChildAt(0)));
        }
        this.readyBtn.touchEnabled = false;
    ...
    p.setWaitcode = function (wailt, obj, oldobj) {
...
egret.registerClass(OverGameSen,'OverGameSen');
//# sourceMappingURL=OverGameSen.js.map