...
class GamePlayView extends eui.Component {
    public static CHUPAINUM = 8;
    // 南北出牌是长宽倒过来的
    public static ZUOYOUCHUPAIWIDTH = 57;
    public static ZUOYOUCHUPAIHEIGHT = 51;
    public static SHANGXIACHUPAIWIDTH = 47;
    public static SHANGXIACHUPAIHEIGHT = 71;
    public static ZIJIPAIWIDTH = 77;
    public static ZIJIPAIHEIGH = 122;
    public static CHUSHIWEIZHI = 50;
    /**
     *等待界面
     */
    public waitSen: WaitSen;
    /**
     *结束界面
     */
    public overSen: OverGameSen;
    /**
    *听图标，庄图标
    */
    private shangName: eui.Label;
    private xiaName: eui.Label;
    private zuoName: eui.Label;
    private youName: eui.Label;

    private shangFen: eui.Label;
    private xiaFen: eui.Label;
    private zuoFen: eui.Label;
    private youFen: eui.Label;




    private xiaTingPng: eui.Image;
    private zuoTingPng: eui.Image;
    private youTingPng: eui.Image;
    private shangTingPng: eui.Image;

    private zuozhuangPng: eui.Image;
    private youzhuangPng: eui.Image;
    private shangzhuangPng: eui.Image;
    private xiazhuangPng: eui.Image;
    /**
     *头部场次类型
     */
    private vipPng: eui.Image;
    private chujiPng: eui.Image;
    private gaojiPng: eui.Image;
    private zhongjiPng: eui.Image;
    /**
     *中间东南西北的展示
     */
    public fangweiGroup: eui.Group;
    private nan: eui.Image;
    private dong: eui.Image;
    private xi: eui.Image;
    private bei: eui.Image;
    private dongTween: egret.Tween;
    private nanTween: egret.Tween;
    private xiTween: egret.Tween;
    private beiTween: egret.Tween;
    /**
     *手上的牌组
     */
    private paiArr: Array<eui.Image>;
    /**
     *当前的位置，东南西北
     */
    public position: string = "dong";
    /**
     *用户名称
     */
     ...
     *是否能出牌
     */
    private ischupai: boolean = false;

    /**
     *自己吃碰的数组，用于最后刷新，不然remove不了
     */
    private dongchipengArr: Array<eui.Image>;
    /**
     *吃完之后手上牌的开始位置 
     */
    private dongchix: number = GamePlayView.CHUSHIWEIZHI;
    /**
     *上面的出牌gourp
     */
    private shangGroup: eui.Group;
    /**
     *右边出牌group
     */
    private youGroup: eui.Group;
    /**
     *左边出牌group
     */
    private zuoGroup: eui.Group;
    /**
     *xia边出牌group
     */
    private xiaGroup: eui.Group;
    /**
     *上面摸的牌
     */
    private shangmoPai: eui.Image;
    private youmoPai: eui.Image;
    private zuomoPai: eui.Image;

    /**
     *吃碰刚按钮
     */
    private chiBtn: eui.Image;
    private pengBtn: eui.Image;
    private gangBtn: eui.Image;
    private guoBtn: eui.Image;
    private tingBtn: eui.Image;
    private qtingBtn: eui.Image;
    private pengtingBtn: eui.Image;
    private butingBtn: eui.Image;
    /**
     *当前动作的人位置，东南西北
     */
     ...
     *当前牌，主要用于吃碰等
     */
    private currentPai: string;
    /**
     *吃碰杠等的牌型
     */
    private chiString: string;
    private pengString: string;
    private pengArr: Array<string> = [];
    private gangString: string;
    private qtingString: string;
    private qtingchiString: string;
    private tingString: string;
    private huString: string;
    /**
     *当前出的那个牌，用于碰或者吃杠的时候，删掉
     */
    private currentChuPai: eui.Image;
    /**
     *存放南边手上牌数组
     */
    private nanArr: Array<eui.Image>;
    /**
     *存放西边手上牌数组
     */
    private xiArr: Array<eui.Image>;
    /**
     *存放北边手上牌数组
     */
    private beiArr: Array<eui.Image>;
    /**
     *右边吃牌个数
     */
    private youchiNum: number = 0;

    /**
     *上边吃牌个数
     */
    private shangchiNum: number = 0;

    /**
     *左边吃牌个数
     */
    private zuochiNum: number = 0;
    /**
     *是否可以多吃
     */
    private isDuochi: boolean = false;
    /**
     *多吃数组
     */
    private duochiArr = [];
     ...
     *多吃存图片数组
     */
    private duochiPngArr = [];
    private huchi: any;
    /**
     *控制获得听牌和抢听的时候，出牌阶段，如果是点击没有弹起的牌，return，点击
     */
    private isTing: boolean = false;
    private isZimo: boolean = false;

    private isPorMO: string = "";

    private chiMovieClip: egret.MovieClip;
    private pengMovieClip: egret.MovieClip;
    private huMovieClip: egret.MovieClip;
    private tingMovieClip: egret.MovieClip;
    private mobaohuMovieClip: egret.MovieClip;
    private shouMovieClip: egret.MovieClip;
    private louhuMovieClip: egret.MovieClip;
    private dafengMovieClip: egret.MovieClip;
    private baozhongbaoMovieClip: egret.MovieClip;
    private hongzhongMovieClip: egret.MovieClip;
    private tianhuMovieClip: egret.MovieClip;
    private dihuMovieClip: egret.MovieClip;
    private menqingtingMovieClip: egret.MovieClip;

    private shezhiSen: ShezhiSen;
    private shezhiBtn: eui.Image;
    ...
    //touxiangpng
    public youPng: eui.Image;
    public shangPng: eui.Image;
    public zuoPng: eui.Image;
    public xiaPng: eui.Image;
    public tuoguanGroup: eui.Group;
    public quxiaotuoguanBtn: eui.Image;
    public paiNumText: eui.Label;

    public baoKuang: eui.Image;
    public baoPai: eui.Image;
    public quanNumText: eui.Label;
    public quanTxt: eui.Label;

    private tileImage: egret.MovieClip;

    private chupaiImage: eui.Image;
    private hupaiImage: eui.Image;
    private chupaiImagekuang: eui.Image;

    private vipWanfabtn: eui.Image;
    public vipwanfaTxt: eui.Label;
    ...
    private timeNumText: eui.Label;
    private timer: egret.Timer;
    private huanbaoTxt: eui.Label;
    private huanbaoPng: eui.Image;
    private oldbaipai: string;

    private dongmanorfeman: boolean = false;
    private nanmanorfeman: boolean = false;
    private ximanorfeman: boolean = false;
    private beimanorfeman: boolean = true;
    public constructor() {
        super();
    ...
    private onTianhuClip(event: egret.MovieClipEvent): void {
    ...
    private onDihuClip(event: egret.MovieClipEvent): void {
    ...
    private onMenqingtingClip(event: egret.MovieClipEvent): void {
    ...
    private onMobaohuClip(event: egret.MovieClipEvent): void {
    ...
    private onLouhuClip(event: egret.MovieClipEvent): void {
    ...
    private onHongzhongClip(event: egret.MovieClipEvent): void {
    ...
    private onDafengClip(event: egret.MovieClipEvent): void {
    ...
    private onBaozhongbaoClip(event: egret.MovieClipEvent): void {
    ...
    private onShouMovieClip(event: egret.MovieClipEvent): void {
    ...
    private onTingMovieClip(event: egret.MovieClipEvent): void {
    ...
    private onHuMovieClip(event: egret.MovieClipEvent): void {
        var that = this;
        setTimeout(function () {
    ...
    private onPengMovieClip(event: egret.MovieClipEvent): void {
    ...
    private onChiMovieClip(event: egret.MovieClipEvent): void {
    ...
    private getPositionPoint(obj: any): egret.Point {
    ...
    */
    public getQting(obj: any): void {
        ...
        if (obj.position == this.position) {
            ...
            // if (this.islou == false)
            //     this.baoPai.texture = RES.getRes("majiang_json." + ServerManager.getInstance().baipai + "dongshow_png");
        } else {
   ...
   */
    public getting(obj: any): void {
        ...
        if (obj.position == this.position) {
            ...
            // this.baoKuang.visible = true;
            // this.baoPai.visible = true;
            // if (this.islou == false)
            //     this.baoPai.texture = RES.getRes("majiang_json." + ServerManager.getInstance().baipai + "dongshow_png");
        } else {
            //别人听只需要显示听的图标，自己听也需要，所以按位置来判断
    ...
    private setSound(str: string, bol: boolean): void {
        if (Math.random() > 0.5) {
    ...
    *获得有人碰
    */
    public getPeng(obj: any, num: number = null): void {
        ...
        if (this.currentChuPai.parent)
            GamePool.getInstance().setPNG(this.currentChuPai.parent.removeChild(this.currentChuPai) as eui.Image);
        ...
        if (obj.position == this.position) {
            ...
            for (var index = 0; index < 2; index++) {
                ...
                GamePool.getInstance().setPNG(this.removeChild(this.paiArr[v1]) as eui.Image, 2);
    ...
    private setAngangMing(array: Array<eui.Image>, num: number): void {
        console.log("有暗杠");
    ...
    //处理暗杠的数组
    private xiagangarr: Array<eui.Image> = [];
    private yougangarr: Array<eui.Image> = [];
    private shanggangarr: Array<eui.Image> = [];
    private zuogangarr: Array<eui.Image> = [];
    public getAGang(obj: any): void {
    ...
    private ischitu: boolean = false;
    /**
    *获得有人吃
    */
    public getChi(obj: any, num: number = null): void {
        this.setPostionLight(obj.position);
    ...
    *获得可以吃碰杠胡等动作
    */
    private qtingchiarrr;
    private oldobj: any;
    private isqting: boolean = false;
    private isActionTing: boolean = false;
    public getAction(obj: any): void {
        // 版本不对的话，不给出现
    ...
    *听
    */
    private onTing(event: egret.TouchEvent): void {
   ...
   *碰听
   */
    private onPengQTing(event: egret.TouchEvent): void {
     ...
     *吃听
     */
    private onQTing(event: egret.TouchEvent): void {
        ...
        if (crr.length == 1) {
            ...
            // for (var index = 0; index < crr.length; index++) {
            ...
            //     pai2.x = 220 + index * 115 + GamePlayView.SHANGXIACHUPAIWIDTH;
            //     pai2.y = 500;
   ...
   */
     ...
     *过动作
     */
    private onGuo(e: egret.TouchEvent) {
        if (this.isActionTing == true) {
            this.isActionTing = false;
            this.ischupai = true;
        }
     ...
     *碰
     */
    private onPeng(e: egret.TouchEvent) {
     ...
     *杠
     */
    private onGang(e: egret.TouchEvent) {
        this.unviewChiPeng();
        ServerManager.getInstance().chipenghu(this.gangString, "gang");
    }
    //多吃时候弹出控制
    private duochitanchu(arr, num) {
        for (var index = 0; index < arr.length; index++) {
            var bg = GamePool.getInstance().getPNG(3);
            bg.texture = RES.getRes("youxi_json.9");
            bg.touchEnabled = true;
    ...
    private onChi(e: egret.TouchEvent) {
     ...
     *多吃时候，点击背景选择吃的那一个
     */
    private onCHIBg(event: egret.TouchEvent): void {
    ...
    private paixu(pai: string, chi: string): string {
        var arr = chi.split(",");
        arr.push(pai);
        arr.sort();
        return arr.toString();
    ...
    private unviewChiPeng() {
        ...
        while (this.duochiPngArr.length > 0) {
            if (this.duochiPngArr[this.duochiPngArr.length - 1].height == 130)
                GamePool.getInstance().setPNG(this.removeChild(this.duochiPngArr.pop()) as eui.Image, 3);
            else
                GamePool.getInstance().setPNG(this.removeChild(this.duochiPngArr.pop()) as eui.Image);
        }
    ...
    */
     ...
     *获得摸牌的信息，
     */
    private themopai: string;
    public getMoPai(obj: any): void {
    ...
    public getChonglian(obj: any, userid: string): string {
        ...
        switch (pp) {
            case "xia":
                if (this.xiaGroup.numChildren > 0)
                    this.currentChuPai = this.xiaGroup.getChildAt(this.xiaGroup.numChildren - 1) as eui.Image;
                break;
            case "you":
                if (this.youGroup.numChildren > 0)
                    this.currentChuPai = this.youGroup.getChildAt(this.youGroup.numChildren - 1) as eui.Image;
                break;
            case "shang":
                if (this.shangGroup.numChildren > 0)
                    this.currentChuPai = this.shangGroup.getChildAt(this.shangGroup.numChildren - 1) as eui.Image;
                break;
            case "zuo":
                if (this.zuoGroup.numChildren > 0)
                    this.currentChuPai = this.zuoGroup.getChildAt(this.zuoGroup.numChildren - 1) as eui.Image;
                break;
            default:
                break;
        }
    ...
    private setTingPng(arr1: any, arr2: any, arr3: any, arr4: any): void {
        if (arr1 == true) {
            this.xiaTingPng.visible = true;
        }
        if (arr2 == true) {
    ...
    private setChiPengDapai(arr1: any, arr2: any, arr3: any, arr4: any): void {
        console.log("chipeng");
    ...
    private setDapai(arr1: any, arr2: any, arr3: any, arr4: any): void {
    ...
    public islou: boolean = false;
    public getStartPai(obj: any, userid: string): string {
    ...
    private setWanfaText(obj: any): void {
        var vipstring = "";
        if (obj.bao == true) {
            vipstring += "红中满天飞\n";
        }
    ...
    private touchOUT(event: egret.TouchEvent): void {
        this.vipwanfaTxt.visible = false;
        console.log("wanfafalse");
    }

    private touchON(event: egret.TouchEvent): void {
    ...
    private oldsetX: number;
    private oldsetY: number;
    private offsetX: number;
    private offsetY: number;
    private draggedObject: eui.Image;
    private onButtonClickPai(e: egret.TouchEvent) {
        if (this.ischupai == false)
            return;
        if (e.target.y <= 578) {
            //chupai,得到系统返回再处理桌面上的牌
    ...
    private onLiaotian(event: egret.TouchEvent): void {
    ...
    private onShezhi(event: egret.TouchEvent): void {
     ...
     *退出成功
     */
    public getExit(obj: any, id: string): void {
        // {"type":"E","userid":"111"}
        //看是不是在等待界面还是在游戏中
     ...
     *设置中间的灯，表示到那个位置的阶段
     */
    private setPostionLight(str: string) {
        this.dong.visible = false;
        this.dongTween.setPaused(true);
        this.nan.visible = false;
        this.nanTween.setPaused(true);
    ...
    private viewOversen(obj: any = null) {
		if (this.chatSen.parent) {
			this.chatSen.onClose();
            this.chatSen.chatContent.text="";
		}
        this.waitSen.closeZhunbei();
        this.unviewChiPeng();
        this.isTing = false;
        ...
        while (this.nanArr.length > 0) {
            GamePool.getInstance().setPNG(this.removeChild(this.nanArr.pop()) as eui.Image);
        }
        while (this.xiArr.length > 0) {
            GamePool.getInstance().setPNG(this.removeChild(this.xiArr.pop()) as eui.Image);
        }
        while (this.beiArr.length > 0) {
            GamePool.getInstance().setPNG(this.removeChild(this.beiArr.pop()) as eui.Image);
        }
        this.zuochiNum = 0;
        while (this.zuoGroup.numChildren > 0) {
            GamePool.getInstance().setPNG(this.zuoGroup.removeChild(this.zuoGroup.getChildAt(0)) as eui.Image);
        }

        this.shangchiNum = 0;
        while (this.shangGroup.numChildren > 0) {
            GamePool.getInstance().setPNG(this.shangGroup.removeChild(this.shangGroup.getChildAt(0)) as eui.Image);
        }

        this.youchiNum = 0;
        while (this.youGroup.numChildren > 0) {
            GamePool.getInstance().setPNG(this.youGroup.removeChild(this.youGroup.getChildAt(0)) as eui.Image);
        }

        while (this.dongchipengArr.length > 0) {
            GamePool.getInstance().setPNG(this.removeChild(this.dongchipengArr.pop()) as eui.Image);
        }
        while (this.paiArr.length > 0) {
            GamePool.getInstance().setPNG(this.removeChild(this.paiArr.pop()) as eui.Image, 2);
        }
        while (this.xiaGroup.numChildren > 0) {
            GamePool.getInstance().setPNG(this.xiaGroup.removeChild(this.xiaGroup.getChildAt(0)) as eui.Image);
        }
